...
@InputType()
class AnnouncementCreateNestedManyWithoutCategoriesInput {
...
export { AnnouncementCreateNestedManyWithoutCategoriesInput as AnnouncementCreateNestedManyWithoutCategoriesInput };
