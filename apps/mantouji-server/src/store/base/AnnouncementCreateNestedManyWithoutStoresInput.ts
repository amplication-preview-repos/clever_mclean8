...
@InputType()
class AnnouncementCreateNestedManyWithoutStoresInput {
...
export { AnnouncementCreateNestedManyWithoutStoresInput as AnnouncementCreateNestedManyWithoutStoresInput };
